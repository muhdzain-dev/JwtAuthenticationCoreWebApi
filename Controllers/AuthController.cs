using JwtAuthenticationCoreWebApi.Data.Dtos;
...
namespace JwtAuthenticationCoreWebApi.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> SeedRoles()
        {
            ...
            if (isUserRoleExist && isAdminRoleExist && isOwnerRoleExist)
            {
                return Ok("Role Seeding Already Exist");
            }
            ...
            return Ok("Seeding Successfully");
